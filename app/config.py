...
# корзина рядом с photos означала бы, что «удалённое» фото по-прежнему
# открывается по прямой ссылке. (Каталог заявок стоит внутри media_dir
# и закрыт иначе — тем, что /media смонтирован по трём подкаталогам.)
#
